          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                Hi there! I am <strong>&nbsp;OKEKE FIDELIS NEWBUEZE</strong>
                <br />A passionate programmer, born and brought up in Nigeria. I
                am a Full Stack Web Developer with React.js, Express.js,
                Node.js, and MongoDb as my tech stack.
                <br />
                I am currently a final year student of Federal University Of
                Technology Owerri department of Project Management Technology
                <br />
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a
                      href="https://github.com/nwabueze1"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
